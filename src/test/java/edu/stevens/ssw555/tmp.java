...
public class tmp {
    ...
    @Test
    public void nullOutputFile() throws Exception {
        Gedcom_Service gedcomService = new Gedcom_Service();

        String simulatedInput = "GedcomService_output.txt\n";
        System.setIn(new ByteArrayInputStream(simulatedInput.getBytes()));
        gedcomService.createOutputFile();
        gedcomService.readAndParseFile("gedcom_test_family.ged");
        gedcomService.printMaps();
    }

    @Test
    public void birthBeforeDeath() throws Exception {
        Gedcom_Service gedcomService = new Gedcom_Service();
